...
public class CouponServiceTest {
	...
	public void saveTest() {
		Coupon coupon = new Coupon("2", "food", 12, "20%", "Bakery");
	...
	public void findByIdTest() throws CouponRequestException {
		when (couponRepository.findById("2")).thenReturn(Optional.of(new Coupon("2","food",20, "20%", "Bakery")));
	...
	public void findallTest() {
		Coupon c1=new Coupon("1","food",20, "20%", "Bakery");
		Coupon c2=new Coupon("2","food",20, "20%", "Bakery");
		Coupon c3=new Coupon("3","food",20, "20%", "Bakery");
		Coupon c4=new Coupon("4","food",20, "20%", "Bakery");
	...
	@Test 
	 public void deleteByIdTest() throws CouponRequestException {
		when (couponRepository.findById("6")).thenReturn(Optional.of(new Coupon("6","food",20, "20%", "Bakery")));
	...
	public void findByCategoryTest() {
		Optional<Coupon> c1=Optional.of(new Coupon("1","food",20, "20%", "Bakery"));
		Optional<Coupon> c3=Optional.of(new Coupon("3","food",20, "20%", "Bakery"));
	...
	public void findByCompanyNameTest() {
		Optional<Coupon> c1=Optional.of(new Coupon("1","food",20, "20%", "Bakery"));
		Optional<Coupon> c2=Optional.of(new Coupon("3","food",20, "20%", "Bakery"));
		List<Optional<Coupon>> coupon= new ArrayList<>();
		coupon.add(c1);
		coupon.add(c2);
